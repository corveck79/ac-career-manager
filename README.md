...
### Windows
**[⬇ Download AC_Career_GT_Edition.exe (v1.19.9)](https://github.com/corveck79/ac-career-manager/releases/latest/download/AC_Career_GT_Edition.exe)**

- Windows 10/11 · No Python needed · ~13 MB single file
- Requires Assetto Corsa installed via Steam

### Linux (AppImage)
**[⬇ Download AC_Career_GT_Edition-1.19.9-x86_64.AppImage](https://github.com/corveck79/ac-career-manager/releases/latest/download/AC_Career_GT_Edition-1.19.9-x86_64.AppImage)**
...
```bash
chmod +x AC_Career_GT_Edition-1.19.9-x86_64.AppImage
./AC_Career_GT_Edition-1.19.9-x86_64.AppImage
```
