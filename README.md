...
### Windows
**[⬇ Download AC_Career_GT_Edition.exe (v1.22.0)](https://github.com/corveck79/ac-career-manager/releases/latest/download/AC_Career_GT_Edition.exe)**
...
### Linux (AppImage)
**[⬇ Download AC_Career_GT_Edition-1.22.0-x86_64.AppImage](https://github.com/corveck79/ac-career-manager/releases/latest/download/AC_Career_GT_Edition-1.22.0-x86_64.AppImage)**
...
```bash
chmod +x AC_Career_GT_Edition-1.22.0-x86_64.AppImage
./AC_Career_GT_Edition-1.22.0-x86_64.AppImage
```
